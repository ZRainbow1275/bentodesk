...
!define LEGAL_REVISION "2026-08-02"
...
BrandingText "BentoDesk · Native · Offline"
...
LangString WelcomeText ${LANG_ENGLISH} "Native Windows desktop organization, fully offline and without telemetry.$\r$\n$\r$\nSetup installs BentoDesk for the current user. Administrator privileges are not required."
LangString WelcomeText ${LANG_SIMPCHINESE} "原生 Windows 桌面整理，完全离线，不包含遥测。$\r$\n$\r$\n安装程序将为当前用户安装 BentoDesk，不需要管理员权限。"
...
LangString OptionsIntro ${LANG_ENGLISH} "BentoDesk is native, fully offline, and contains no telemetry."
LangString OptionsIntro ${LANG_SIMPCHINESE} "BentoDesk 原生、完全离线运行，不包含任何遥测。"
