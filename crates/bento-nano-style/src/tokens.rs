...
//! ## Layering
//!
//! `bento_nano_style::tokens` is the **single source of truth** for Tauri-
//! aligned visual tokens. The existing `bento-nano-theme::PaletteTokens`
...
// (see `bento_nano_platform::d2d::solid_brush`); we store straight-alpha here
