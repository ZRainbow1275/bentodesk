...
//!
//! | theme    | Tauri CSS stack (`presets.ts`)                         | nano family |
//! |----------|--------------------------------------------------------|-------------|
...
//!
//! nano renders via DirectWrite `text_format_from_family_name_with_metrics`,
...
//! Win11, so nano maps each to the FIRST Win11-GUARANTEED face in the stack:
