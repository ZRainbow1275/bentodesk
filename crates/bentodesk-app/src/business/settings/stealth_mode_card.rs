...
use bentodesk_widget::{TextNode, Toggle, WidgetNode};
...
fn read_stealth_settings() -> (bool, bool, bool) {
    ...
    let read_bool = |v: &bentodesk_backend::config_vault::Vault, key: &str| -> bool {
...
/// `bentodesk-backend::stealth::StealthStatus` shape. Mirrors the 1.x
...
impl StatusLevel {
    ...
    /// callable from a future `bentodesk-backend::stealth::StealthStatus`
    ...
    /// `bentodesk_backend::stealth::StealthStatus` snapshot to the pill
    ...
    pub fn from_status(s: &bentodesk_backend::stealth::StealthStatus) -> Self {
    ...
    pub const fn label_id(self) -> bentodesk_style::StringId {
        match self {
            Self::Applied => bentodesk_style::i18n_zh_cn::ids::STEALTH_STATUS_APPLIED,
            Self::Pending => bentodesk_style::i18n_zh_cn::ids::STEALTH_STATUS_PENDING,
            Self::Failed => bentodesk_style::i18n_zh_cn::ids::STEALTH_STATUS_FAILED,
        }
    }
}
...
mod tests {
    ...
    use bentodesk_backend::stealth::StealthStatus;
    ...
    fn from_status_applied_when_clean() {
        ...
        assert_eq!(
            ...
            bentodesk_style::i18n_zh_cn::ids::STEALTH_STATUS_APPLIED
        );
    }
    ...
    fn from_status_failed_when_error_and_unapplied() {
        ...
        assert_eq!(
            StatusLevel::from_status(&s).label_id(),
            bentodesk_style::i18n_zh_cn::ids::STEALTH_STATUS_FAILED
        );
    }
