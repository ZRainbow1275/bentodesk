//! `RulesWizard` — 5-step modal that creates / edits a `bentodesk_backend::
//! rules::Rule` (Outlook-style file-organisation engine).
//!
//! 1.x source: `bentodesk/src/components/RulesWizard/RulesWizard.tsx` ships a
//! list-+-form layout. The native redesign keeps the same data model (`Rule`,
...
//! # Save flow
//!
//! The widget is a *shell* — it doesn't talk to `bentodesk_backend::rules`
...
use bentodesk_backend::rules::{ConditionGroup, ConditionNode, Rule, RunMode};
