...
pub const TAGLINE_ZH: &str = "由 Rust 驱动，极致优雅的下一代便当盒式 Windows 桌面整理器。";
pub const TAGLINE_EN: &str = "Powered by Rust, BentoDesk is a refined, next-generation bento-box organizer for the Windows desktop.";
...
mod tests {
    ...
    #[test]
    fn taglines_keep_the_product_statement_in_both_languages() {
        assert_eq!(
            TAGLINE_ZH,
