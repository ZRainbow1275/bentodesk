...
//! # Save flow
//!
//! The widget is a *shell* — it doesn't talk to `bentodesk_backend::layout`
...
use bentodesk_backend::layout::persistence::{BentoZone, ZoneUpdate};
...
// `bentodesk-backend`) does not implement it, and adding `PartialEq` there
