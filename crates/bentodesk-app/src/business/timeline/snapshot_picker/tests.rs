use super::*;
use bentodesk_backend::layout::Resolution;
...
fn make_snapshot(zones: usize) -> DesktopSnapshot {
    DesktopSnapshot {
        ...
        dpi: 1.0,
        zones: (0..zones)
            .map(|i| bentodesk_backend::layout::BentoZone {
...
fn snapshot_picker_chrome_accepts_explicit_radius_shadow_tokens() {
    ...
    let radius = bentodesk_theme::RadiusTokens {
    ...
    let mut shadow = bentodesk_theme::shadow::DEFAULT;
    shadow.md = Shadow {
        offset_x: 2.0,
        offset_y: 5.0,
        blur: 13.0,
