...
//!
//! Backend dep: `bentodesk_backend::timeline::{CheckpointMeta, DeltaSummary,
...
use bentodesk_backend::timeline::{CheckpointMeta, DeltaSummary};
use bentodesk_style::tokens::{PaletteTauri, RadiusTauri, ShadowTauri};
use bentodesk_style::{BorderRadius, Color, Edges, Rect, Shadow, Size};
...
mod tests {
    use super::*;
    use bentodesk_backend::timeline::Checkpoint;
    ...
    fn make_meta(id: &str, summary: &str) -> CheckpointMeta {
        ...
        let cp = Checkpoint {
            id: SmolStr::from(id),
            snapshot: bentodesk_backend::layout::DesktopSnapshot {
