...
fn m6b_brutalism_flattens_family2_widget_shadow() {
    ...
    assert_eq!(app.active_theme_shadow().md, bentodesk_style::Shadow::NONE);
...
fn m6b_dark_family2_stays_byte_identical() {
    ...
    assert_eq!(
        ...
        bentodesk_theme::DARK_DEFAULT.radius
    );
    assert_eq!(
        app.active_theme_shadow(),
        bentodesk_theme::DARK_DEFAULT.shadow
    );
    assert_eq!(
        app.active_theme_typography().font_family,
        bentodesk_theme::DARK_DEFAULT.typo.font_family,
    );
}
