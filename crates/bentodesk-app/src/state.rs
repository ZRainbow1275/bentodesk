...
use bentodesk_zone::{DEFAULT_ZONE_DISPLAY_MODE, Zone, ZoneId, ZoneItemId, ZoneList};
...
pub struct AppState {
    ...
    /// directories from `bentodesk_backend::desktop_sources::all_desktop_dirs`,
    ...
    /// synchronous `bentodesk_backend::stealth::status()` probe when Settings
    ...
    pub stealth_status: RefCell<Option<bentodesk_backend::stealth::StealthStatus>>,
    ...
    /// a persisted theme id through `bentodesk_backend::themes`, then writes
