...
impl Renderer {
    ...
    pub(super) fn draw_keybindings_modal(&mut self, app: &AppState) -> Result<(), RenderError> {
        ...
        self.draw_text_chromatic_title(
            bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::KEYBINDINGS_TITLE),
            title_rect,
            title_color,
        ...
        for (row_index, row) in keybindings_section::keybinding_rows().iter().enumerate() {
            ...
            let chip_rect = bentodesk_style::Rect {
                x: row_rect.x + 146.0,
                y: row_rect.y + spacing_tokens.xs,
                width: 116.0,
                height: 22.0,
            ...
            let chord = if recording_this {
                smol_str::SmolStr::new(bentodesk_style::t(
                    bentodesk_style::i18n_zh_cn::ids::KEYBINDINGS_RECORDING,
                ))
            } else {
                keybindings_section::current_chord_for_action(row.action).unwrap_or_else(|| {
                    smol_str::SmolStr::new(bentodesk_style::t(
                        bentodesk_style::i18n_zh_cn::ids::KEYBINDINGS_UNSUPPORTED,
                    ))
                })
            };
            self.draw_text(
            ...
            self.draw_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::KEYBINDINGS_RECORD),
            ...
            self.draw_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::KEYBINDINGS_RESET),
            ...
            {
                let feedback_rect = bentodesk_style::Rect {
                    x: row_rect.x,
                    y: row_rect.y + 18.0,
    ...
    pub(super) fn draw_about_panel(&mut self, app: &AppState) -> Result<(), RenderError> {
        ...
        self.draw_about_app_icon(bentodesk_style::Rect {
        ...
        self.draw_about_avatar(bentodesk_style::Rect {
            x: avatar.x + 2.0,
            y: avatar.y + 2.0,
