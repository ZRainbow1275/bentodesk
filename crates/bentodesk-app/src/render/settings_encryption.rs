...
impl Renderer {
    pub(super) fn draw_settings_encryption(
        ...
        // Native derives equivalent neutral chrome from the active palette
        ...
        if row_visible(enc_label, body) {
            self.draw_text_no_wrap_with_style(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_CARD_TITLE),
                enc_label,
                title_color,
                15.0,
                600,
        ...
        if row_visible(enc_desc, body) {
            self.draw_text_with_style(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_CARD_DESC),
                enc_desc,
                enc_desc_color,
                12.0,
                400,
        ...
        if row_visible(enc_current, body) {
            let current_label =
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_CURRENT_MODE);
            ...
            let label_part = bentodesk_style::Rect {
                x: enc_current.x,
                y: enc_current.y,
                width: label_w,
            ...
            label_result?;
            let value_part = bentodesk_style::Rect {
        ...
        for index in 0..SETTINGS_ENCRYPTION_MODE_COUNT {
            ...
            let (title_id, sub_id) = match index {
                0 => (
                    bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_MODE_NONE,
                    bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_MODE_NONE_SUB,
                ),
                1 => (
                    bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_MODE_DPAPI,
                    bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_MODE_DPAPI_SUB,
                ),
                _ => (
                    bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_MODE_PASSPHRASE_FULL,
                    bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_MODE_PASSPHRASE_SUB,
                ),
            };
            ...
            let sub_rect = bentodesk_style::Rect {
                x: btn.x + 12.0,
        ...
        if row_visible(enc_pass_label, body) {
            let label_text_rect = bentodesk_style::Rect {
                x: enc_pass_label.x,
            ...
            self.draw_text_no_wrap_with_style(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_PASSPHRASE_LABEL),
                label_text_rect,
                title_color,
                13.0,
                400,
        ...
        if row_visible(enc_input, body) {
            ...
            if enc_pass_len == 0 && !enc_passphrase_focused {
                ...
                self.draw_text_no_wrap_with_style(
                    bentodesk_style::t(
                        bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_PASSPHRASE_PLACEHOLDER,
                    ),
                    text_rect,
        ...
        if row_visible(enc_hint, body) {
            self.draw_text_with_style(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::ENCRYPTION_PASSPHRASE_HINT),
                enc_hint,
                enc_muted,
                11.0,
                400,
