    ...
    pub(super) fn draw_settings_updater(
        ...
        if row_visible(updater_label, body) {
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_CARD_TITLE),
                updater_label,
                label_color,
            )?;
        }
        ...
        if row_visible(upd_status_row, body) {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_STATUS_LABEL),
                label_rect,
                label_color,
            )?;
            ...
            self.draw_settings_button_text(
                bentodesk_style::t(upd::updater_status_label_id(&updater_status)),
                pill,
                pill_fg,
                11.0,
                600,
        ...
        if upd_middle.height > 0.0 && row_visible(upd_middle, body) {
            match updater_flags.updater_kind {
                UpdaterHeightKind::Versioned => {
                    ...
                    self.draw_settings_text(
                        bentodesk_style::t(
                            bentodesk_style::i18n_zh_cn::ids::UPDATER_AVAILABLE_VERSION,
                        ),
                        label_rect,
                        label_color,
                    )?;
                ...
                UpdaterHeightKind::Downloading => {
                    ...
                    let track_radius = bentodesk_style::BorderRadius::all(track.height * 0.5);
        ...
        if row_visible(upd_btn_row, body) {
            ...
            self.draw_settings_button_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_CHECK_NOW),
                check_btn,
                accent_on,
                12.0,
                500,
            ...
            if upd::updater_show_download(&updater_status) {
                ...
                self.draw_settings_button_text(
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_DOWNLOAD),
                    dl_btn,
                    accent_on,
                    12.0,
                    500,
                ...
                self.draw_settings_button_text(
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_INSTALL_RESTART),
                    install_btn,
                    accent_on,
                    12.0,
                    500,
            ...
            if upd::updater_show_skip(&updater_status) {
                ...
                self.draw_settings_button_text(
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_SKIP_VERSION),
                    skip_btn,
                    title_color,
                    12.0,
                    500,
        ...
        if row_visible(upd_freq_row, body) {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_FREQUENCY),
                label_rect,
                label_color,
            )?;
            ...
            let freq_id = match app.update_check_frequency.get() {
                bentodesk_backend::updater::UpdateCheckFrequency::Daily => {
                    bentodesk_style::i18n_zh_cn::ids::UPDATER_FREQ_DAILY
                }
                bentodesk_backend::updater::UpdateCheckFrequency::Weekly => {
                    bentodesk_style::i18n_zh_cn::ids::UPDATER_FREQ_WEEKLY
                }
                bentodesk_backend::updater::UpdateCheckFrequency::Manual => {
                    bentodesk_style::i18n_zh_cn::ids::UPDATER_FREQ_MANUAL
                }
            };
            self.draw_settings_button_text(
                bentodesk_style::t(freq_id),
                chip,
                title_color,
                12.0,
                500,
        ...
        if row_visible(upd_auto_row, body) {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::UPDATER_AUTO_DOWNLOAD),
                label_rect,
                label_color,
            )?;
