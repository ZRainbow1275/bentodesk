    ...
    pub(super) fn draw_settings_general_paths(
        ...
        if row_visible(general_label, body) {
            self.draw_settings_group_title(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTINGS_GROUP_GENERAL),
                general_label,
                palette.text_muted,
            )?;
        }
        ...
        let toggle_labels: [u16; 5] = [
            bentodesk_style::i18n_zh_cn::ids::SETTING_DESKTOP_EMBED.0,
            bentodesk_style::i18n_zh_cn::ids::SETTING_AUTOSTART.0,
            bentodesk_style::i18n_zh_cn::ids::SETTING_SHOW_IN_TASKBAR.0,
            bentodesk_style::i18n_zh_cn::ids::SETTING_SMART_LAYOUT.0,
            bentodesk_style::i18n_zh_cn::ids::SETTING_PORTABLE_MODE.0,
        ];
        ...
        for index in 0..SETTINGS_TOP_TOGGLE_COUNT {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::StringId(toggle_labels[index as usize])),
                label_rect,
                label_color,
            )?;
            // Toggle.
        ...
        if row_visible(locale_row, body) {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTING_LANGUAGE),
                label_rect,
                label_color,
            )?;
            let chip = settings_language_chip_rect(viewport, scroll);
            self.fill_rounded_rect(chip, chip_bg, chip_radius)?;
            let chip_hairline = bentodesk_style::Rect {
                x: chip.x,
                y: chip.y,
                width: chip.width,
                height: 1.0,
            ...
            let locale_label = if bentodesk_style::current_locale_is(&bentodesk_style::EN_US) {
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::LOCALE_LABEL_EN_US)
            } else {
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::LOCALE_LABEL_ZH_CN)
            };
        ...
        if row_visible(paths_label, body) {
            self.draw_settings_group_title(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTINGS_GROUP_PATHS),
                paths_label,
                palette.text_muted,
            )?;
        }
        ...
        if row_visible(sources_label, body) {
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SECTION_DESKTOP_SOURCES),
                sources_label,
                label_color,
            )?;
        }
        ...
        let card_radius = bentodesk_style::BorderRadius::all(8.0);
        ...
        for index in 0..visible_sources {
            ...
            // var(--border-zen)` — the native card previously had NO stroke).
            ...
            let (icon_bg, icon_glyph, kind_label_id) = match kind {
                bentodesk_backend::desktop_sources::DesktopSourceKind::User => (
                    bentodesk_style::Color::from_u8(59, 130, 246, 191), // 0.75
                    "U",
                    bentodesk_style::i18n_zh_cn::ids::SOURCE_PRIMARY_LABEL,
                ),
                bentodesk_backend::desktop_sources::DesktopSourceKind::Public => (
                    bentodesk_style::Color::from_u8(34, 197, 94, 191),
                    "P",
                    bentodesk_style::i18n_zh_cn::ids::SOURCE_PUBLIC_LABEL,
                ),
                bentodesk_backend::desktop_sources::DesktopSourceKind::OneDrive => (
                    bentodesk_style::Color::from_u8(14, 165, 233, 191), // sky (fixed)
                    "O",
                    bentodesk_style::i18n_zh_cn::ids::SOURCE_ONEDRIVE_LABEL,
                ),
                bentodesk_backend::desktop_sources::DesktopSourceKind::Custom => (
                    bentodesk_style::Color::from_u8(168, 85, 247, 191), // purple (fixed)
                    "C",
                    bentodesk_style::i18n_zh_cn::ids::SOURCE_CUSTOM_LABEL,
                ),
            };
            self.fill_rounded_rect(
                icon_rect,
                icon_bg,
                bentodesk_style::BorderRadius::all(ICON_SIZE * 0.5),
            )?;
            self.draw_text_no_wrap_with_style(
                icon_glyph,
                icon_rect,
                bentodesk_style::Color::WHITE,
                12.0,
                600,
                1.0,
                dwrite::TextAlign {
            ...
            self.draw_text_with_style(
                bentodesk_style::t(kind_label_id),
                label_rect,
                title_color,
                13.0,
                500,
            ...
            let path_rect = bentodesk_style::Rect {
                x: body_x,
            ...
            if *watched {
                let badge_text =
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SOURCE_WATCHED_BADGE);
                ...
                let badge_rect = bentodesk_style::Rect {
                ...
                self.fill_rounded_rect(
                    badge_rect,
                    badge_bg,
                    bentodesk_style::BorderRadius::all(10.0),
                )?;
                self.draw_text_no_wrap_with_style(
                    badge_upper.as_str(),
                    badge_rect,
        ...
        // 11px, text_muted) when no desktop sources resolve. native's refresh is
        ...
        if visible_sources == 0 {
            ...
            let empty_rect = bentodesk_style::Rect {
                x: label.x + 4.0,
                y: label.bottom() + 6.0,
            ...
            if row_visible(empty_rect, body) {
                ...
                self.draw_text_with_style(
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SOURCE_EMPTY_PLACEHOLDER),
                    empty_rect,
                    palette.text_muted,
                    11.0,
                    400,
        ...
        if row_visible(refresh_btn, body) {
            self.fill_rounded_rect(
                refresh_btn,
                chip_bg,
                bentodesk_style::BorderRadius::all(6.0),
            )?;
        ...
        if row_visible(path_label, body) {
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SECTION_DESKTOP_PATH),
                path_label,
                label_color,
            )?;
        }
        // Input/textarea boxes keep the radius-10 surface the M2 layout shipped.
        let input_box_radius = bentodesk_style::BorderRadius::all(10.0);
        ...
        if row_visible(watch_label, body) {
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SECTION_WATCH_VALUES),
                watch_label,
                label_color,
            )?;
        }
        ...
        if row_visible(watch_area, body) {
            ...
            if watch_text.is_empty() {
                // Hint placeholder.
                let hint_rect = bentodesk_style::Rect {
                    x: watch_area.x + 12.0,
                    y: watch_area.y + 10.0,
                ...
                self.draw_settings_text(
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::WATCH_HINT_LINE_EACH),
                    hint_rect,
                    label_color,
                )?;
            } else {
