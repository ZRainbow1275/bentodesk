...
impl Renderer {
    pub(super) fn draw_settings_performance_startup(
        ...
        // (hibernation). The hit-tester in `bentodesk-shell::ui::settings_hit`
        // + the dispatch arms in `main.rs` route every control fully through
        // paint→hit→dispatch→persist→snapshot.
        let slider_track_radius = bentodesk_style::BorderRadius::all(2.0);
        let slider_thumb_radius = bentodesk_style::BorderRadius::all(SETTINGS_SLIDER_THUMB_D * 0.5);
        ...
        if row_visible(perf_label, body) {
            self.draw_settings_group_title(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTINGS_GROUP_PERFORMANCE),
                perf_label,
                label_color,
            )?;
        }
        ...
        let perf_rows: [(u16, i32, i32, &'static str); 3] = [
            (
                bentodesk_style::i18n_zh_cn::ids::SETTING_EXPAND_DELAY.0,
                crate::state::EXPAND_DELAY_MIN_MS,
                crate::state::EXPAND_DELAY_MAX_MS,
                "ms",
            ),
            (
                bentodesk_style::i18n_zh_cn::ids::SETTING_COLLAPSE_DELAY.0,
                crate::state::COLLAPSE_DELAY_MIN_MS,
                crate::state::COLLAPSE_DELAY_MAX_MS,
                "ms",
            ),
            (
                bentodesk_style::i18n_zh_cn::ids::SETTING_ICON_CACHE_SIZE.0,
        ...
        for index in 0..SETTINGS_PERF_ROW_COUNT {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::StringId(label_id)),
                label_rect,
                label_color,
            )?;
            ...
            let track_band = bentodesk_style::Rect {
                x: track.x,
            ...
            let filled = bentodesk_style::Rect {
                x: track_band.x,
                y: track_band.y,
        ...
        if row_visible(startup_label, body) {
            self.draw_settings_group_title(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTINGS_GROUP_STARTUP),
                startup_label,
                label_color,
            )?;
        }
        ...
        if row_visible(high_row, body) {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTING_STARTUP_HIGH_PRIORITY),
                label_rect,
                label_color,
            )?;
        ...
        // Row 0 desc caption.
        let high_desc = bentodesk_style::Rect {
            x: high_row.x,
        ...
        if row_visible(high_desc, body) {
            self.draw_settings_text(
                bentodesk_style::t(
                    bentodesk_style::i18n_zh_cn::ids::SETTING_STARTUP_HIGH_PRIORITY_DESC,
                ),
                high_desc,
        ...
        if row_visible(crash_row, body) {
            ...
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTING_CRASH_RESTART),
                label_rect,
                label_color,
            )?;
        ...
        let crash_desc = bentodesk_style::Rect {
            x: crash_row.x,
        ...
        if row_visible(crash_desc, body) {
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTING_CRASH_RESTART_DESC),
                crash_desc,
                with_alpha(label_color, 0.7),
            )?;
        }
        ...
        if crash_restart_on {
            let stepper_rows: [(u16, Rect, i32); 2] = [
                (
                    bentodesk_style::i18n_zh_cn::ids::SETTING_CRASH_MAX_RETRIES.0,
                    settings_crash_max_retries_row_rect(viewport, scroll),
                    app.crash_max_retries.get(),
                ),
                (
                    bentodesk_style::i18n_zh_cn::ids::SETTING_CRASH_WINDOW_SECS.0,
        ...
        if row_visible(safe_row, body) {
            ...
            self.draw_settings_text(
                bentodesk_style::t(
                    bentodesk_style::i18n_zh_cn::ids::SETTING_SAFE_START_HIBERNATION,
                ),
                label_rect,
                label_color,
            )?;
        ...
        let safe_desc = bentodesk_style::Rect {
            x: safe_row.x,
        ...
        if row_visible(safe_desc, body) {
            self.draw_settings_text(
                bentodesk_style::t(
                    bentodesk_style::i18n_zh_cn::ids::SETTING_SAFE_START_HIBERNATION_DESC,
                ),
                safe_desc,
                with_alpha(label_color, 0.7),
            )?;
        ...
        if safe_start_on {
            ...
            if row_visible(row, body) {
                ...
                self.draw_settings_text(
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTING_HIBERNATE_DELAY),
                    label_rect,
                    label_color,
                )?;
