    ...
    pub(super) fn draw_settings_plugins(
        ...
        if row_visible(plugin_label, body) {
            self.draw_settings_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTINGS_PLUGINS),
                plugin_label,
                label_color,
            )?;
        }
        ...
        if row_visible(plugin_install, body) {
            ...
            self.draw_settings_button_text(
                bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::PLUGIN_INSTALL),
                plugin_install,
                label_color,
                13.0,
                500,
        ...
        if plg::plugin_list_is_empty(&plugin_entries) {
            ...
            if row_visible(empty_row, body) {
                self.draw_text_no_wrap_with_style(
                    bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::PLUGIN_EMPTY),
                    empty_row,
                    palette.text_muted,
                    12.0,
                    400,
                ...
                .enumerate()
            {
                ...
                self.fill_rounded_rect(
                    ...
                    bentodesk_style::BorderRadius::all(badge_rect.height * 0.5),
                )?;
                self.draw_settings_button_text(
                    bentodesk_style::t(plg::plugin_type_label_id(plugin.plugin_type.as_str())),
                    badge_rect,
                ...
                let toggle_radius = bentodesk_style::BorderRadius::all(toggle_rect.height * 0.5);
                self.fill_rounded_rect(
                    toggle_rect,
                ...
                self.draw_settings_button_text(
                    if plugin.enabled {
                        bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::BTN_ON)
                    } else {
                        bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::BTN_OFF)
                    },
                    toggle_rect,
                    if plugin.enabled {
                        controls.on_accent
                ...
                if plugin_uninstall_confirm == Some(card_index) {
                    ...
                    let prompt_rect = bentodesk_style::Rect {
                        x: desc_rect.x,
                        y: uninstall_btn.y,
                    ...
                    self.draw_text_no_wrap_with_style(
                        bentodesk_style::t(
                            bentodesk_style::i18n_zh_cn::ids::PLUGIN_CONFIRM_UNINSTALL,
                        ),
                        prompt_rect,
                    ...
                    self.draw_settings_button_text(
                        bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::SETTING_CANCEL),
                        cancel_btn,
                        label_color,
                        12.0,
                        500,
                    ...
                    self.draw_settings_button_text(
                        bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::BTN_CONFIRM),
                        uninstall_btn,
                    ...
                    self.draw_settings_button_text(
                        bentodesk_style::t(bentodesk_style::i18n_zh_cn::ids::PLUGIN_UNINSTALL),
                        uninstall_btn,
                        palette.readable_text_on(palette.accent_red),
                        12.0,
                        500,
