...
//! `bentodesk-app` — application orchestration.
//!
...
//!
//! This crate wires `bentodesk-tree`, `bentodesk-widget`, `bentodesk-layout`
//! and `bentodesk-platform` together. The render pass lives here so the
