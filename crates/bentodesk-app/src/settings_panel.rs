...
//! crate. Keeping them in `bentodesk-app` (which both `bentodesk-shell`
...
use bentodesk_style::{Rect, Shadow, Size, tokens as style_tokens};

/// Panel size in DIPs — 360×580 vertical card matching Tauri 1.2.4 frame_060.
///
/// The Settings HWND is 800 × 600 (see `bentodesk_platform::window::
