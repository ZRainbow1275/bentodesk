...
fn m1h_settings_hit_resolves_inline_plugin_install_toggle_and_per_card_uninstall() {
    ...
    for card_index in 0..visible {
        ...
        let uninstall = bento_nano_app::settings_panel::settings_plugin_uninstall_button_rect(card);
        assert_eq!(
            settings_hit(
                &app,
    ...
    let confirm = bento_nano_app::settings_panel::settings_plugin_uninstall_button_rect(first_card);
    assert_eq!(
        settings_hit(
            &app,
    ...
    let cancel =
        bento_nano_app::settings_panel::settings_plugin_uninstall_cancel_button_rect(first_card);
    assert_eq!(
        settings_hit(
            &app,
