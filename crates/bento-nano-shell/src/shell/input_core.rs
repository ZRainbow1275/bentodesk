...
pub(super) fn window_slot_logical_viewport(slot: &WindowSlot) -> bento_nano_style::Size {
...
pub(super) fn zone_item_max_scroll(app: &AppState, zone: &bento_nano_zone::Zone) -> f32 {
