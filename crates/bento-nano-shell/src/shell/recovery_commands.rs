...
) -> bento_nano_backend::config_vault::SettingValue {
    match value {
        bento_nano_app::SettingValue::Bool(value) => {
            bento_nano_backend::config_vault::SettingValue::Bool(*value)
        }
        bento_nano_app::SettingValue::Int(value) => {
            bento_nano_backend::config_vault::SettingValue::Int(*value)
        }
        bento_nano_app::SettingValue::Float(value) => {
            bento_nano_backend::config_vault::SettingValue::Float(*value)
        }
        bento_nano_app::SettingValue::Str(value) => {
            bento_nano_backend::config_vault::SettingValue::Str(value.clone())
        }
    }
}
