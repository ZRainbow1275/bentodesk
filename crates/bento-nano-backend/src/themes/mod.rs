...
//! a [`bento_nano_theme::ThemeTokens`] struct that the renderer consumes.
//!
...
//!   `tauri::Emitter`. The nano port replaces them with plain functions taking
...
//!   The nano port keeps that data contract for installed or pre-extracted
