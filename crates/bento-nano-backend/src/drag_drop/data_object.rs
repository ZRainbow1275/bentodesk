...
fn shell_id_list_array_format() -> u16 {
...
fn shell_object_offsets_format() -> u16 {
...
fn in_shell_drag_loop_format() -> u16 {
...
fn supported_format_at(index: usize) -> Option<FORMATETC> {
...
fn format_is_supported(fmt: &FORMATETC) -> bool {
