...
//!
//! In 1.x each minibar was a standalone Tauri `WebviewWindow`. The nano
...
//!
//! The actual HWND lifecycle is owned by `bento-nano-shell::window::factory`
...
//! memory cost; the nano rationale is per-HWND swap chain cost (R5 / R7 in
