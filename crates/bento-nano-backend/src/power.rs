...
//! `try_state::<...>()`. The nano single-process invariant means each
...
//! lets the dispatcher (`bento-nano-app::dispatcher`) decide which
//! subsystems to wake.
//!
//! The `WM_POWERBROADCAST` decode itself lives in the wndproc subclass
//! (`bento-nano-shell::window::wndproc`); this module exposes the public
