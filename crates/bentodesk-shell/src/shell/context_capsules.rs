...
pub(super) enum ContextCapsuleError {
    ...
    Codec(PlatformError),
    Base64(bentodesk_backend::config_vault::wire::Base64Error),
...
impl From<bentodesk_backend::config_vault::wire::Base64Error> for ContextCapsuleError {
    fn from(value: bentodesk_backend::config_vault::wire::Base64Error) -> Self {
        Self::Base64(value)
    }
}
...
pub(super) const CONTEXT_CAPSULE_ZONES_CODEC: &str = "bentodesk-zones-bin-v1";
...
pub(super) fn default_context_capsule_name() -> SmolStr {
    SmolStr::new(format!(
        ...
        bentodesk_backend::time::now_compact_rfc3339()
    ))
}
...
pub(super) fn encode_context_capsule_envelope(
    ...
    let envelope = ContextCapsuleEnvelope {
        ...
        captured_at: bentodesk_backend::time::now_rfc3339(),
        zones_codec: CONTEXT_CAPSULE_ZONES_CODEC.to_owned(),
        zones_bin_b64: bentodesk_backend::config_vault::wire::base64_encode(&storage::encode(
            zones,
        )),
        windows,
    };
...
pub(super) fn envelope_entry_from_payload(
    ...
    CapsuleEntry::new(
        ...
        "archive",
        bentodesk_backend::time::system_time_to_rfc3339(fallback_modified),
    )
}
...
pub(super) fn decode_context_capsule_zones(
    ...
    let zones_payload =
        bentodesk_backend::config_vault::wire::base64_decode(&envelope.zones_bin_b64)?;
    ...
    for item in read_dir {
        ...
        let entry = match std::fs::read(&path) {
            ...
            Err(_) => CapsuleEntry::new(
                ...
                display_name_from_context_capsule_id(capsule_id.as_str()),
                "archive",
                bentodesk_backend::time::system_time_to_rfc3339(modified),
            ),
        };
...
pub(super) fn capture_context_capsule_for_path(
    ...
    Ok(CapsuleEntry::new(
        ...
        "briefcase",
        bentodesk_backend::time::now_rfc3339(),
    ))
}
