...
pub(super) fn persist_rule_run_stats(
    ...
    rule.last_run = Some(SmolStr::new(bentodesk_backend::time::now_rfc3339()));
...
pub(super) fn apply_rules_move_to_zone(
    ...
    for file in files {
        ...
        let item_path = bentodesk_app::ItemPath::new(file.path.clone());
...
pub(super) fn tag_target_matches_item(file_path: &str, item: &bentodesk_zone::ZoneItem) -> bool {
