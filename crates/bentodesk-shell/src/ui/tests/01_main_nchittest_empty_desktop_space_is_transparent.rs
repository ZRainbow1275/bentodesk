...
fn main_nchittest_keeps_app_rendered_context_menu_clickable() {
    ...
    rows.push(popover::ContextMenuRow::command(
        1,
        "Edit zone",
        bentodesk_app::business::icons::IconKind::Edit,
    ));
...
fn settings_nchittest_drags_from_painted_header_but_not_close_button() {
    ...
    let header = bentodesk_app::settings_panel::settings_header_rect(viewport);
    let close = bentodesk_app::settings_panel::settings_close_button_rect_m1(viewport);
...
fn search_nchittest_keeps_margin_transparent_and_header_draggable() {
    ...
    let close = bentodesk_app::business::search_bar::search_close_rect(viewport);
    assert_eq!(
...
fn zone_editor_nchittest_drags_only_header_and_preserves_close_input() {
    ...
    let header = bentodesk_app::zone_editor_geometry::zone_editor_header_rect(viewport);
    let close = bentodesk_app::zone_editor_geometry::zone_editor_close_rect(viewport);
    let input = bentodesk_app::zone_editor_geometry::zone_editor_name_input_rect(viewport);
...
fn bulk_manager_nchittest_keeps_header_search_and_close_interactive() {
    ...
    let search = bentodesk_app::business::bulk_manager_panel::bulk_manager_search_rect(viewport);
    let close = bentodesk_app::business::bulk_manager_panel::bulk_manager_close_rect(viewport);
...
include!("01_main_nchittest_empty_desktop_space_is_transparent/continuation.rs");
