...
fn minibar_pointer_item_maps_to_open_item_command() {
    ...
    let item_rect =
        bentodesk_app::business::minibar::minibar_item_rect(viewport, &bar, 0).expect("item rect");
...
fn file_info(path: &std::path::Path) -> FileInfo {
    FileInfo {
        ...
        file_type: path
            ...
            .unwrap_or("unknown")
            .to_string(),
        modified_at: bentodesk_backend::time::now_rfc3339(),
        created_at: bentodesk_backend::time::now_rfc3339(),
...
fn offgrid_desktop_highlight_uses_icon_position_backup() {
    ...
    let layout = bentodesk_backend::icon_positions::SavedIconLayout {
        ...
        saved_at: bentodesk_backend::time::now_rfc3339(),
    ...
    bentodesk_backend::icon_positions::persist_to_file(&layout, state_dir)
