...
use bentodesk_platform::{MonitorInfo, RectI32, enumerate_monitors, zone_active_monitor_index};
...
/// `bentodesk-platform/tests/zone_monitor_smoke.rs`).
...
/// `bentodesk_platform::enumerate_monitors()` afresh. We cannot pump a
