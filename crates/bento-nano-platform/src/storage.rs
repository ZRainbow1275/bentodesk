...
/// Compatibility alias used by pre-2.0 native runners and integrations.
const LEGACY_STATE_DIR_ENV: &str = "BENTODESK_NANO_STATE_DIR";
...
#[cfg(test)]
use paths::{state_dir_override_path_from_value, state_dir_override_path_from_values};
