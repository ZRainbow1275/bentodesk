...
pub use settings_panel::{
    ...
    settings_encryption_mode_rect, settings_panel_rect, settings_plugin_row_rect,
    settings_plugin_toggle_rect, settings_plugin_uninstall_rect, settings_plugins_close_rect,
    settings_plugins_install_rect, settings_plugins_modal_rect, settings_plugins_open_rect,
    settings_plugins_refresh_rect, settings_recovery_create_rect,
