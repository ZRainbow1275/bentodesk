...
pub(super) fn chrome_region_rects(app: &AppState) -> SmallVec<[bento_nano_style::Rect; 16]> {
...
pub(super) fn effective_zone_chrome_rect(app: &AppState, zone: &Zone) -> bento_nano_style::Rect {
    use bento_nano_style::Rect;
