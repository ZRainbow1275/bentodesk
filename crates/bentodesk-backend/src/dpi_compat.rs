...
//!
//! ## Why duplicated from `bentodesk-platform::dpi`
//!
//! `bentodesk-backend` must stay self-contained — it does **not** depend on
//! `bentodesk-platform` (master plan layer 2.5 boundary). So the same
