...
mod tests {
    ...
    /// real BentoDesk autostart entry.
    const TEST_VALUE_NAME: &str = "BentoDesk__unit_test_marker__";
    ...
    const TEST_ABSENT_VALUE_NAME: &str = "BentoDesk__unit_test_absent_marker__";
